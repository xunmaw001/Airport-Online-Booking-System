<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="航班编号" prop="hangbanbianhao">
          <el-input v-model="ruleForm.hangbanbianhao" 
              placeholder="航班编号" clearable  :readonly="ro.hangbanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="航班编号" prop="hangbanbianhao">
              <el-input v-model="ruleForm.hangbanbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="航空公司" prop="hangkonggongsi">
          <el-input v-model="ruleForm.hangkonggongsi" 
              placeholder="航空公司" clearable  :readonly="ro.hangkonggongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="航空公司" prop="hangkonggongsi">
              <el-input v-model="ruleForm.hangkonggongsi" 
                placeholder="航空公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="飞行方式" prop="feixingfangshi">
        ...
        <div v-else>
          <el-form-item class="input" label="飞行方式" prop="feixingfangshi">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="中转或经停的地点" prop="zhongzhuanhuojingtingdedidian">
          <el-input v-model="ruleForm.zhongzhuanhuojingtingdedidian" 
              placeholder="中转或经停的地点" clearable  :readonly="ro.zhongzhuanhuojingtingdedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="中转或经停的地点" prop="zhongzhuanhuojingtingdedidian">
              <el-input v-model="ruleForm.zhongzhuanhuojingtingdedidian" 
                placeholder="中转或经停的地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="飞行时长" prop="feixingshizhang">
          <el-input v-model="ruleForm.feixingshizhang" 
              placeholder="飞行时长" clearable  :readonly="ro.feixingshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="飞行时长" prop="feixingshizhang">
              <el-input v-model="ruleForm.feixingshizhang" 
                placeholder="飞行时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="乘机地点" prop="chengjididian">
          <el-input v-model="ruleForm.chengjididian" 
              placeholder="乘机地点" clearable  :readonly="ro.chengjididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="乘机地点" prop="chengjididian">
              <el-input v-model="ruleForm.chengjididian" 
                placeholder="乘机地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	zhongzhuanhuojingtingdedidian : false,
	chufashijian : false,
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.feixingfangshi = true;
          ...
          if(o=='zhongzhuanhuojingtingdedidian'){
            this.ruleForm.zhongzhuanhuojingtingdedidian = obj[o];
	    this.ro.zhongzhuanhuojingtingdedidian = true;
            continue;
          }
          if(o=='chufashijian'){
